...
import {
  normalizeImageOrientation as _normalizeImageOrientation,
  type Rotation,
} from './normalizeImageOrientation.js';
import { detectImageType } from './utils.js';

pdfjsLib.GlobalWorkerOptions.workerSrc = PDFJSWorker as unknown as string;

export function arrayBufferToDataURL(buffer: ArrayBuffer): Promise<string> {
...
export const normalizeImageOrientation = async (buffer: ArrayBuffer): Promise<ArrayBuffer> =>
  _normalizeImageOrientation(buffer, {
    applyRotation: async (buffer: ArrayBuffer, rotation: Rotation) => {
